                ...
                <form action="{{ route('menu.store') }}" method="post" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="harga" placeholder="5000"
                                    class="w-full bg-[#121212] border-white/10 rounded-2xl pl-12 pr-6 py-4 text-white font-body focus:border-orange-500 focus:ring-1 focus:ring-orange-500 transition shadow-inner"
                                    required />
                            </div>
                        </div>
                    ...
                    <div>
                        <label
                            ...
                            Produk</label>
                        <div
                            class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-white/10 border-dashed rounded-2xl hover:border-orange-500/50 transition-colors group">
                            <div class="space-y-1 text-center">
                                <svg class="mx-auto h-12 w-12 text-gray-500 group-hover:text-orange-500 transition"
                                ...
                                <div class="flex text-sm text-gray-400 font-body">
                                    <label for="foto_menu"
                                        class="relative cursor-pointer bg-transparent rounded-md font-bold text-orange-500 hover:text-orange-400 focus-within:outline-none">
