<x-app-layout>
    <div class="min-h-screen bg-[#121212] text-white py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <h3 class="font-body text-xl font-bold mb-6 italic uppercase tracking-widest text-white/50">Pilih Warung Terlebih Dahulu:</h3>
                    ...
                    <a href="{{ route('pembeli.shop.detail', $shop->id) }}" 
                       class="bg-[#1e1e1e] group overflow-hidden rounded-3xl border border-white/5 hover:border-orange-500/50 transition-all duration-300 shadow-xl flex flex-col">
                        ...
                        <div class="h-48 w-full overflow-hidden relative">
                            @if($shop->foto_warung)
                                <img src="{{ asset('storage/' . $shop->foto_warung) }}" 
                                     alt="{{ $shop->nama_warung }}" 
                                     class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                            @else
                                <div class="w-full h-full bg-gradient-to-br from-orange-500/20 to-black flex items-center justify-center">
                            ...
                            <div class="absolute top-4 right-4 bg-black/60 backdrop-blur-md px-3 py-1 rounded-full border border-white/10">
                                <span class="text-[10px] font-bold text-orange-500 uppercase">Buka</span>
                            </div>
                        </div>

                        <div class="p-6 flex items-center justify-between">
                            <div class="flex items-center space-x-4">
                                <div class="bg-orange-500/10 p-3 rounded-xl group-hover:bg-orange-500 transition-all duration-300">
                                    <svg class="w-6 h-6 text-orange-500 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div class="text-left">
                                    <h3 class="font-display text-xl font-bold text-white group-hover:text-orange-500 transition capitalize">
                                        {{ $shop->nama_warung }}
                                    </h3>
                            ...
                            <div class="translate-x-4 opacity-0 group-hover:opacity-100 group-hover:translate-x-0 transition-all">
